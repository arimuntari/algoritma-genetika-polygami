...
<body>
    ...
    <a class="navbar-brand" href="#">Percobaan</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
            ...
            <li class="nav-item <?php echo $act=="ga"?"active":"";?>">
                <a class="nav-link" href="index.php?act=ga">Genethic Algorithm</a>
            </li>
    ...
    <?php
        switch ($act) {
            ...
            case "ga":
                include "ga.php";
                break;
            case "gameankalimantan":
                include "gameankalimantan.php";
                break;
            default:
                include "dashboard.php";
        }
    ?>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAvWqP3cNlLkF4plEgY6f8DoTNnY3zC3TM&callback=initMap&libraries=&v=weekly" async></script>
